...
dos2022 <- "r-parsers\\outdos2022\\"
indir   <- paste0(dos2022)
outfile <- paste0(dos2022,election,"__",election_area,".csv")
ff      <- paste0(dos2022,election,"__",election_area,".txt")
